...
export function convertHubConnection(hubConnection: SignalR.HubConnection): CollierHubConnection {
    ...
    const upgradedHubConnection: CollierHubConnection = Object.assign(hubConnection, {
